...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute md:-left-12 left-2 bottom-16 md:top-1/2 md:-translate-y-1/2 z-20 h-12 w-12 md:h-8 md:w-8 rounded-full bg-white md:bg-transparent shadow-md md:shadow-none border border-gray-200",
        className
      )}
      ...
      {...props}
    >
      <svg width="24" height="24" fill="none" stroke="black" strokeWidth="2" viewBox="0 0 24 24" className="h-6 w-6 md:h-4 md:w-4"><path d="M15 6l-6 6 6 6" strokeLinecap="round" strokeLinejoin="round"/></svg>
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute md:-right-12 right-2 bottom-16 md:top-1/2 md:-translate-y-1/2 z-20 h-12 w-12 md:h-8 md:w-8 rounded-full bg-white md:bg-transparent shadow-md md:shadow-none border border-gray-200",
        className
      )}
      ...
      {...props}
    >
      <svg width="24" height="24" fill="none" stroke="black" strokeWidth="2" viewBox="0 0 24 24" className="h-6 w-6 md:h-4 md:w-4"><path d="M9 6l6 6-6 6" strokeLinecap="round" strokeLinejoin="round"/></svg>
